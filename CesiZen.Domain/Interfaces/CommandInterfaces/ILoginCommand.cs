...
{
    Task<IResult> UpdateLogin(Login login);
    ...
    Task<IResult> AddResetPasswordToken(Login login);
    ...
    Task<IResult> UpdateResetPasswordAttempsCount(int loginId, int? FailedCount);

    Task<IResult> UpdateResetPasswordAttemps(Login login);
}
