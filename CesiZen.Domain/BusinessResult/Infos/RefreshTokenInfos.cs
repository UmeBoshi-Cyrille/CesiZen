...
{
    #region Log Messages
    public static Info LogInsertionSucceeded(string identifier) => new(InfoType.InsertionSucceeded, string.Format(ResourceMessages.GetResource("InfoMessages", "LOG_INSERT_SUCCESS"), "RefreshToken", identifier));
    public static Info LogUpdateSucceeded(string id) => new(InfoType.UpdateSucceeded, string.Format(ResourceMessages.GetResource("InfoMessages", "LOG_UPDATE_SUCCESS"), "RefreshToken", id));
    public static Info LogUpdateProperty(string property) => new(InfoType.UpdateSucceeded, string.Format(ResourceMessages.GetResource("InfoMessages", "LOG_UPDATE_PROPERTY"), "RefreshToken", property));
