...
public static class BreathExerciseInfos
{
    ...
    public static Info LogUpdateSucceeded => new(InfoType.UpdateSucceeded, string.Format(Message.GetResource("InfoMessages", "LOG_UPDATE_SUCCESS"), "Breath exercise"));
    ...
    public static Info LogDeleteCompleted => new(InfoType.DeleteCompleted, string.Format(Message.GetResource("InfoMessages", "LOG_DELETION_SUCCESS"), "Breath exercise"));
