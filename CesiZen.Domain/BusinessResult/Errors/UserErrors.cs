...
public static class UserErrors
{
    ...
    #region Log Messages
    public static Error LogRegisterFailed(int Identifier) => new(ErrorType.RegisterFailed, string.Format(Message.GetResource("ErrorMessages", "LOG_REGISTER_FAILED"), identifier));
    ...
    public static Error LogLoginAttempsReached(int Identifier) => new(ErrorType.LoginAttempsReached, string.Format(Message.GetResource("ErrorMessages", "LOG_LOGIN_ATTEMPS_REACHED"), identifier));
    public static Error LogResetPasswordAttempsReached(int Identifier) => new(ErrorType.ResetPasswordAttempsReached, string.Format(Message.GetResource("ErrorMessages", "LOG_RESET_PASSWORD_ATTEMPS_REACHED"), identifier));
